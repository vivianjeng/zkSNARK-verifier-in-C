...
mod parse {
    ...
    pub fn parse_g1_json(e: &<Bn256 as bellman::pairing::Engine>::G1Affine) -> String {
        ...
        format!("{} {}", 
                BigInt::parse_bytes(parsed.0.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string(), 
                BigInt::parse_bytes(parsed.1.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string())
    }
    ...
    pub fn parse_g2_json(e: &<Bn256 as bellman::pairing::Engine>::G2Affine) -> String {
        ...
        format!(
            ...
            BigInt::parse_bytes(parsed.0.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string(), 
            BigInt::parse_bytes(parsed.1.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string(), 
            BigInt::parse_bytes(parsed.2.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string(), 
            BigInt::parse_bytes(parsed.3.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string(),
        )
    }
    ...
    pub fn parse_fr_json(e: &Fr) -> String {
        ...
        format!("{}", BigInt::parse_bytes(parsed.trim_start_matches("0x").as_bytes(), 16).unwrap().to_str_radix(10).to_string())
    }
